...
public class Managment {
    ...
    public Managment() {
        ...
        products.add(new Drinks("Basis.Basis.Drinks",1.05, 3,10));
    ...
    public void generalInfo(){
        for (int i = 0; i < this.machines.size(); i++) {
        System.out.println("Basis.Basis.Machine: " + this.machines.get(i).getId());

        this.machines.get(i).getMoney().info();
        System.out.println("Basis.Basis.Money: " + this.machines.get(i).getMoney().getTotal());
